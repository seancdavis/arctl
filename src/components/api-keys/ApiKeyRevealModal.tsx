    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="api-key-reveal-title">
      ...
      <div className="relative bg-[var(--surface-1)] border border-[var(--border)] rounded-xl shadow-2xl max-w-lg w-full p-6">
        ...
        <div className="relative mb-4">
          <code className="block w-full p-3 text-xs font-mono bg-[var(--surface-0)] border border-[var(--border)] rounded-lg text-[var(--accent-green)] break-all select-all">
            {rawKey}
          </code>
        </div>
        ...
        <div className="flex gap-3">
          <button
            onClick={handleCopy}
            className="btn-neon flex-1 px-4 py-2.5 rounded-lg text-sm flex items-center justify-center gap-2"
          >
            {copied ? (
              <>
          ...
          <button
            onClick={onClose}
            className="px-4 py-2.5 rounded-lg text-sm bg-[var(--surface-3)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-4)] transition-colors"
          >
            Done
          </button>
        </div>
